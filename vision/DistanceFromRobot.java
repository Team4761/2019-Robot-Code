...
import static org.robockets.deepspace.Robot.AngleEntry;
import static org.robockets.deepspace.Robot.WidthEntry;
import static org.robockets.deepspace.Robot.visionTable;
	...
	public static void main(String... args) {
		...
		if (cameras.size() >= 1) {
			VisionThread visionThread = new VisionThread(cameras.get(0),
				...
				AngleEntry.setDouble(FinalAngle);
				WidthEntry.setDouble(FinalWidth);
			});
			visionThread.start();
		}
