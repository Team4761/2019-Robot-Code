...
public class OI {
	...
	public static JoystickButton button102 = new JoystickButton(buttonBoard1, 2); // Extra
	...
	public static JoystickButton button108 = new JoystickButton(buttonBoard1, 8); // Cargo Low
	...
	public static JoystickButton button122 = new JoystickButton(buttonBoard1, 22); // Cargo ship
	...
	public OI() {
		...
		button122.whenPressed(new SetCargoPos(CargoPos.CARGO));

		button203.whileHeld(new RunCargoIntake(1));
		button202.whileHeld(new RunCargoIntake(-1));

		button223.whileHeld(new MoveCargoArm(0.1));
		button222.whileHeld(new MoveCargoArm(-0.1));
		...
		// Climber
		button105.whenPressed(new Climb());
